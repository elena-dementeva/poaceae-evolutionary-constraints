...
#### Analysis of CNEs: miRNA-target search and GO-enrichnent, TFBS and neighbouring genes search and GO-encrichment  

- **Analysis of miRNA targets**   

**miRNAs** (microRNAs) are short non-coding RNAs of approximately 21–24 nucleotides in length that play a key role in regulation of **gene expression** on a post-transcriptional level. They function by binding to **target mRNAs**, inhibiting **translation**. In plants, **miRNAs** are involved in a wide range of biological processes, including growth, development, adaptation and response to biotic and abiotic stresses.
Studying constrained **miRNAs** allows us to reveal the mechanisms underlying adaptation as well to determine ways to increase productivity.

##### Results  

- **765 hairpin structures** predicted in constrained regions with **RNAfold**
- **14 sequences** correspoded to plant miRNAs from **miRBase**
- **15 mRNA targets** identified with **psTargetFinder**
- **3 GO terms** showed the processes involved in regulation of phosphate transport, phosphate ion homeostasis, cellular response to phosphate starvation.

![img](images/miRNA_targets_GO.png)  
*Figure above shows the results of GO enrichment analysis for miRNA targets in constrained regions. The top 3 enriched GO terms are shown, with their respective term IDs and adjusted p-values.*

##### Biological Interpretation  

Presence of miRNAs in constrained regions indicates strong selective pressure and their conservation across bread wheat and related species suggests shared adaptive mechanisms.
Phosphate metabolism is a vital process for wheat growth and reproduction under nutrient-limited conditions, highlighting potential adaptations to low-nutrient soils.

- **TFBS**  

**Transcription factor binding sites (TFBS)** are regions of DNA where transcription factors bind to regulate gene expression. Identifying TFBS in conserved regions helps understand how regulatory networks evolve and adapt.  

##### Results  
- **67 motifs** identified using **MEME** in constrained regions
- **35 genes** found nearby the motifs
- **GO enrichment** with **GOMO** revealed processes related to transcription regulation, DNA binding, and translation
...
The presence of conserved TFBS suggests they play a crucial role in regulating gene expression and are shown to be involved in regulation of transcription and translation.
