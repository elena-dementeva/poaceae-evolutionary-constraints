...
``` bash
python scripts/plot_phyloP_wind.py input.tsv --highlight gene --background CDS
```
...
7.  Visit [g:Profiler](https://biit.cs.ut.ee/gprofiler/gost)

8.  Upload `tf_target_genes.txt`

9.  Select *Triticum aestivum* as organism
